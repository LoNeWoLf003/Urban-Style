...
class personal_care extends StatelessWidget {
  const personal_care({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: home_controller.load_personal_care(context),
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "personal care"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
