...
class all extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: home_controller.load_items(context),
        ...
        if(snapshot.connectionState == ConnectionState.waiting){
          ...
          return snapshot.data == null
            ...
            return Padding(
                ...
                child: InkWell(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => product_info(title: snapshot.data[index]["title"], price: "₹ ${snapshot.data[index]["price"]}", image: snapshot.data[index]["image"], stock: snapshot.data[index]["stock"],des: snapshot.data[index]["description"],lat: snapshot.data[index]["lat"],long: snapshot.data[index]["long"],)));
                  },
                  child: Container(
