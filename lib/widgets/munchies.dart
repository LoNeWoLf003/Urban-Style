...
class munchies extends StatelessWidget {
  const munchies({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: home_controller.load_munchies(context),
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "munchies"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
