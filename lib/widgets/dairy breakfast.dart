...
class dairy_breakfast extends StatelessWidget {
  const dairy_breakfast({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "dairy & breakfast"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
