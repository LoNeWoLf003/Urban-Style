...
class cleaning_essentials extends StatelessWidget {
  const cleaning_essentials({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: home_controller.load_cleaning_essentials(context),
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "cleaning essentials"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
