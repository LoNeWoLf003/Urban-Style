...
class frozen_food extends StatelessWidget {
  const frozen_food({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "frozen food"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
