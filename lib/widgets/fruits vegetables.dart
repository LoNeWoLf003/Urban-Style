...
class fruits_vegetables extends StatelessWidget {
  const fruits_vegetables({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text('Showing results for "fruits & vegetables"',style: TextStyle(fontWeight: FontWeight.bold),),
                      )),
                  Padding(
                    padding:
